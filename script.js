                ...
                const showSuccess = () => {
                    ...
                    if (resType === 'studio') {
                        ...
                        document.getElementById('resSuccessMessage').innerHTML = `
                            ...
                            <!-- ★要設定: SquareまたはStripeの決済URLを設定してください ★ -->
                            <a href="https://square.link/YOUR_PAYMENT_LINK" target="_blank" class="btn outline-btn" style="margin-top: 20px; width: 100%; border-color: #fff; color: #fff;">決済に進む</a>
                        `;
                    }
